...
const KaryaCard = ({ karya, onClick }: KaryaCardProps) => {
  ...
  return (
    <Card 
      onClick={onClick}
      className="group overflow-hidden relative flex flex-col bg-secondary-dark border border-grayMid/30 rounded-3xl transition-all duration-300 cursor-pointer hover:border-grayMid/60 hover:shadow-lg"
    >
