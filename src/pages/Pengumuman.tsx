    ...
    >
      ...
      >
        <motion.div 
          ...
          className="backdrop-blur-xl bg-black/40 border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6 overflow-hidden relative"
        >
          ...
          <div className="flex items-center gap-3 mb-4 sm:mb-6 relative z-10">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-white/5 border border-white/10 flex items-center justify-center shadow-xl">
              <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-white/80" />
            </div>
            <h2 className="text-lg sm:text-xl font-serif font-semibold bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
              Agenda Komunitas
            </h2>
          </div>
          
          <Separator className="bg-white/5 mb-4 sm:mb-6" />
          ...
          <div className="space-y-4 sm:space-y-5">
            {announcements.map((announcement, index) => (
              <motion.div
                ...
                className="backdrop-blur-xl bg-black/30 border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-6 hover:bg-white/5 transition-all duration-300 group relative overflow-hidden"
              >
                ...
                <div className="flex items-start gap-3 sm:gap-4 relative z-10">
                  <div className={`p-2 sm:p-3 rounded-lg sm:rounded-xl backdrop-blur-md bg-white/5 border ${announcement.accentColor} transform transition-transform group-hover:scale-110 duration-300`}>
                    {announcement.icon}
                  </div>
                  <div className="flex-1 space-y-2 sm:space-y-3">
                    <div className="flex flex-wrap items-start sm:items-center justify-between gap-2">
                      <h3 className="text-base sm:text-xl font-serif font-semibold bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent transform transition-transform group-hover:-translate-y-1 duration-300">
                        {announcement.title}
                      </h3>
                      <div className="flex flex-wrap gap-2 sm:gap-3 items-center">
                        <span className="bg-white/10 backdrop-blur-md px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-xs text-white/70 border border-white/5">
                          {announcement.tag}
                        </span>
                        <div className="backdrop-blur-md bg-black/20 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm text-white/80 border border-white/10 transform transition-transform group-hover:translate-y-1 duration-300">
                          {announcement.date}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden mt-2 sm:mt-4">
                      <motion.div 
        ...
        >
          ...
          <div className="relative">
            {/* Connector line */}
            <div className="absolute h-full w-[1px] bg-gradient-to-b from-white/5 via-white/20 to-white/5 left-4 sm:left-6 top-0 z-0 ml-3 sm:ml-3.5"></div>
            ...
            <div className="space-y-4 sm:space-y-5 relative z-10">
              {flowchartSteps.map((step, index) => (
                ...
                >
                  <div className="relative flex flex-col items-center">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full backdrop-blur-md bg-white/5 border border-white/20 flex items-center justify-center z-10">
                      {step.icon}
                    </div>
                    {index !== flowchartSteps.length - 1 && (
                      <div className="h-10 sm:h-12 w-[1px] bg-white/5"></div>
                    )}
                  </div>
                  
                  <div className="backdrop-blur-xl bg-black/20 border border-white/10 rounded-lg sm:rounded-xl p-3 sm:p-4 flex-1">
                    <h3 className="text-sm sm:text-lg font-serif font-semibold bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent mb-1">
                      {step.title}
                    </h3>
              ...
              >
                <div className="relative">
                  <div className="absolute -left-5 sm:-left-7 top-1/2 w-4 sm:w-6 h-[1px] bg-white/20"></div>
                  <div className="absolute -left-5 sm:-left-7 -top-4 h-10 w-[1px] bg-white/20"></div>
                  <div className="backdrop-blur-xl bg-black/20 border border-white/10 rounded-lg sm:rounded-xl p-3 sm:p-4">
                    <h3 className="text-sm sm:text-lg font-serif font-semibold bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent mb-1">
              ...
              >
                <div className="text-white/50 text-xs sm:text-sm backdrop-blur-xl bg-white/5 border border-white/10 rounded-full px-3 sm:px-4 py-1 sm:py-2">
        ...
        <motion.div 
          variants={itemVariants}
          className="backdrop-blur-xl bg-black/30 border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-center relative overflow-hidden"
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-4 sm:mb-6">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full backdrop-blur-md bg-white/5 border border-white/10 flex items-center justify-center">
              <Instagram className="w-5 h-5 sm:w-6 sm:h-6 text-white/80" />
            </div>
          </div>
          
          <h3 className="text-xl sm:text-2xl font-serif font-semibold bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent mb-3 sm:mb-4">
        ...
        <motion.div 
          variants={itemVariants}
          className="backdrop-blur-xl bg-black/30 border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6 text-center relative overflow-hidden"
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-2 sm:mb-3">
            <AlertCircle className="w-3 h-3 sm:w-4 sm:h-4 text-white/50" />
            <p className="text-white/50 text-xs sm:text-sm font-medium">Informasi Penting</p>
          </div>
          
          <p className="text-white/70 relative z-10 text-xs sm:text-sm">
