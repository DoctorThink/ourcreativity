...
const BrandStory = () => {
  return (
    <PageLayout
      title="CERITA KAMI"
      subtitle="Perjalanan & Nilai Inti OurCreativity"
    >
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 relative z-10" // Slightly reduced gap
      >
        {/* --- Card: Origin Story --- */}
        <motion.div
          ...
          className={cn(
            "md:col-span-2 lg:col-span-1 p-5 rounded-3xl border relative overflow-hidden shadow-md", // Using rounded-3xl, slightly smaller padding
