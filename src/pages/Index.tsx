  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 bg-background -z-10">
        ...
        <div className="absolute w-[70vw] h-[70vh] rounded-full blur-[120px] bg-amethyst/3 -top-[20%] -right-[20%]" />
        <div className="absolute w-[50vw] h-[50vh] rounded-full blur-[100px] bg-turquoise/3 -bottom-[10%] -left-[10%]" />
        <div className="absolute w-[40vw] h-[40vh] rounded-full blur-[80px] bg-coral/3 bottom-[30%] right-[5%]" />
        
        {/* Enhanced Grid overlay with softer dot pattern */}
        <div className="absolute inset-0 geometric-dot-pattern opacity-20" />
        <div className="absolute inset-0 geometric-line-pattern opacity-15" />
        
        {/* Animated subtle lines */}
        <div className="absolute left-[5%] top-[10%] w-[1px] h-[30vh] bg-gradient-to-b from-transparent via-lavender/15 to-transparent animate-pulse-soft" />
        <div className="absolute right-[10%] top-[20%] w-[1px] h-[40vh] bg-gradient-to-b from-transparent via-mint/15 to-transparent animate-pulse-soft" />
        <div className="absolute left-[20%] bottom-[10%] w-[40vw] h-[1px] bg-gradient-to-r from-transparent via-peach/15 to-transparent animate-pulse-soft" />
        
        {/* Floating geometric shapes with softer borders */}
        <div className="absolute top-[15%] left-[15%] w-16 h-16 border border-lavender/15 rounded-full animate-float" style={{ animationDelay: "-2s" }} />
        <div className="absolute bottom-[25%] right-[25%] w-24 h-24 border border-mint/15 rounded-full animate-float" style={{ animationDelay: "-1s" }} />
        <div className="absolute top-[40%] right-[10%] w-12 h-12 border border-peach/15 morphing-blob animate-float" style={{ animationDelay: "-3s" }} />
      </div>
        ...
        >
          {navigationItems.map(({ icon: Icon, text, href, color, decorColor }) => (
            ...
            >
              ...
              >
                {/* Enhanced background gradient with softer opacity */}
                <div className={`absolute inset-0 bg-gradient-to-br ${color} opacity-20 transition-opacity duration-300 group-hover:opacity-40`}></div>
